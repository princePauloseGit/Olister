...
page 50213 "Create Price List"
{
            ...
            Group(General)
            {
                ...
                field("Vendor No"; "Vendor No.")
                {
                    ...
                    begin
                        ...
                        Activity.SetFilter("Vendor No.", '<>%1', '');
    ...
    begin
        if CloseAction = CloseAction::OK then begin
            ...
            if IsSale then
                ...
                if "Vendor No." = '' then
                    Error('Vendor No. must be specified to create Purchase Price List.')
                else
    ...
    begin
        ...
        PLL.Validate("Product No.", ItemNo);
        PLL.Validate("Asset No.", ItemNo);
        PLL.Validate("Variant Code", Activityrec."Item Variant");
